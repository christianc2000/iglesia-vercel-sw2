          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/miembro"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("miembro") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/evento"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("evento") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/ministerio"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("ministerio") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
              ...
              {/* <!-- Menu Tipo de donación */}
              <li>
                <Link
                  href="/tipodonacion"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("tipodonacion") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/cargo"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("cargo") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <line fill="none" stroke="#ffffff" x1="12" y1="16" x2="27" y2="16" />
                    <rect x="5" y="14" fill="none" stroke="#ffffff" width="4" height="4" />
                    <line fill="none" stroke="#ffffff" x1="12" y1="8" x2="27" y2="8" />
                    <rect x="5" y="6" fill="none" stroke="#ffffff" width="4" height="4" />
                    <line fill="none" stroke="#ffffff" x1="12" y1="24" x2="27" y2="24" />
                    <rect x="5" y="22" fill="none" stroke="#ffffff" width="4" height="4" />
                  </svg>
                  Cargo
                </Link>
              </li>
