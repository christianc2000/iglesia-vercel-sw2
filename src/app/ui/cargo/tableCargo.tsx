...
import RemoveBtnCargo from "./RemoveBtn";
import { GET_CARGOS } from '@/query/cargoQuery';


const TableCargo = () => {
    const { data, refetch} = useSuspenseQuery(GET_CARGOS);
    const cargos = data.findAllCargos;
    useEffect(() => {
                            ...
                            <tr key={cargo.id}>
                                ...
                                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div className="flex items-center space-x-3.5">
                                        ...
                                        <RemoveBtnCargo id={cargo.id} refetch={refetch} />
                                    </div>
                                </td>
                            </tr>
                        ))}
