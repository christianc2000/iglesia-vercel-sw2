...
const CREATE_MINISTERIO = gql`
  mutation CreateMinisterio($nombre: String!, $descripcion: String!) {
    createMinisterio(nombre: $nombre, descripcion: $descripcion) {
      id
      nombre
      descripcion
    }
...
export default function CreateeMinisterio() { // Asegúrate de usar 
    ...
    const [CreateMinisterio] = useMutation(CREATE_MINISTERIO);
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true)
        try {
            const { data } = await CreateMinisterio({
                variables: { nombre, descripcion }
            });
            // console.log('Ministerio create:', data.createMinisterio);
        ...
        <DefaultLayout>
            <Breadcrumbs
                breadcrumbs={[
                    ...
                    { label: 'Crear Ministerio', href: '/ministerio/create' },
                ]}
            />
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="p-6.5">
                                ...
                                <div className="mb-4.5">
                                    ...
                                    <input type="text" placeholder="Descripción" className="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" value={descripcion} onChange={(e) => setDescripcion(e.target.value)} />
                                </div>
